//lists just like doubly linked list insertion and deletion are O(1)
//non contigous memory, therefore accessing elements by index is not possible is not possible
#include <iostream>
#include <list>
using namespace std;
